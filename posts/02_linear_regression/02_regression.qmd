...
# Ethics Enclave: On Prediction

:::: {.columns}

::: {.column width="30%"}
![AI Snake Oil](AI_Snake_Oil.png)
:::
...
::: {.column width="60%"}
> Broadly speaking, machine learning is more suited to predicting things about individuals whereas simulation is more suited for predicting collective or global outcomes

--- *AI Snake Oil*, page 65

> ... life outcomes are hard to predict, we are using a combination of these three criteria: real-world utility, moral legitimacy, and irreducible error, that is, error that won't go away with more data and better computational errors.

--- *AI Snake Oil*, page 69

> What if we can't make accurate predictions because there aren't enough people on Earth to learn all the patterns that exist? 
