...
This semester, Derek tried out a series of "Multipass" assigments to aid in the literature process
...
* Copy-and-paste the content of the paper into a word cloud generator (such as [www.wordclouds.com](www.wordclouds.com)). Copy-and-paste the word cloud (or upload the image) back here.	

* Based on your word cloud, what do you think the research paper is about?
...
* image source: [Vamshi Prakash](https://medium.com/@vamshiprakash001/an-introduction-to-bag-of-words-bow-c32a65293ccc)
:::
...
* Summarize the abstract, introduction, and conclusion of the paper (with about 3 sentences here).
...
* image source: [Joyce Xu](https://medium.com/nanonets/topic-modeling-with-lsa-psla-lda-and-lda2vec-555ff65b0b05)
:::
...
* Ask an AI chatbot (e.g. ChatGPT, Claude) to give you an overview of the paper's topic. Also, please indicate which chatbot you used.
...
![foundation models](llm.png)

* image source: [Sumit Singh](https://www.labellerr.com/blog/an-introduction-to-large-language-models-llms/)
:::
...
* Prompt the chatbot to also polish your writing above (from Questions 2 and 3).  Place the chatbot's response here.
...
* image source: [Minerva CQ](https://www.minervacq.com/post/make-customer-service-reps-smarter-with-rag-retrieval-augmented-generation)
:::
...
* Finally, combine the results from the above tasks into one paragraph.  Please have the majority of the work as your own work.
...
![Human in the Loop](human_loop.png)

* image source: [Stanford HAI](https://hai.stanford.edu/news/humans-loop-design-interactive-ai-systems)
:::
...
* Understand the main **concepts** of machine learning in supervised learning, unsupervised learning, and artificial intelligence
